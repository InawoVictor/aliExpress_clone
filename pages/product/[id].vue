<template>
    <div id="ProductPage" class="mt-4 max-w-[1200px] mx-auto px-2">
        ...
        >
            <div class="md:w-[40%]">
                <img class="rounded-lg object-fit"
                    :src="currentImage" 
                    alt="Product Image"
                >

                <div
                    v-if="images[0] !== ''" class="flex items-center justify-center mt-2"
                >
            ...
            <div
                class="md:w-[60%] bg-white p-3 rounded-lg"
            >
                <div v-if="true">
                ...
                <div class="flex items-center justify-start gap-2">   
                    ...
                    <span 
                        class="bg-[#F5F5F5] border text-[#C08563]
                        text-[9px] font-semibold px-1.5 rounded-sm"
                    >
                        70% off
                    </span>
                </div>
                ...
                <button
                    @click="addToCart"
                    :disabled="isInCart"
                    class="px-6 py-2 rounded-lg text-lg 
                    text-white font-semibold bg-gradient-to-r from-[#FF851A] to-[#FFAC2C]"
                >
