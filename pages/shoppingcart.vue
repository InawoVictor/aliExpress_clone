        ...
        <div v-if="false" class="h-[500px] flex items-center justify-center">
            <div class="pt-0">
                <img 
                    width="250"
                    class="mx-auto"
                    src="/cart-empty.png" alt="Empty cart"
                >
                ...
                <div v-if="true" class="flex text-center">
                    <NuxtLink
                        to="/auth"
                        class="bg-[#FD374F] w-full text-white ttext-[21px] font-semibold
        ...
        <div v-else class="md:flex gap-4 justify-between mx-auto w-full">
            ...
            <div class="md:w-[35%]">
                    <div id="Summary" class="bg-white rounded-lg p-4">
                        ...
                        <button
                            @click="goToCheckout"
                            class="flex items-center justify-center bg-[#FD374F] mt-4
...
const totalPriceComputed = computed(() => {
    let price = 0
    userStore.cart.forEach(prod => price += prod.price)
    return price / 100
})
