<template>
    <div class="flex justify-start my-2 ">
        <div class="my-auto">
            ...
            >            
                <div
                    ...
                    class="flex items-center justify-center h-[20px] w-[20px] border-[1px] rounded-full ml-2"
                    :class="[
        ...
        <img 
            class="rounded-md md:w-[150px] w-[90px] sm:ml-6 ml-4"
            :src="product.img" 
            alt="Product Image"
        >
        ...
        <div class="overflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    <span
                        class="sm:block hidden bg-[#FD374F] 
                        text-white text-[9px] font-semibold px-1.5 rounded-sm min-w-[80px]"
                    >
                        Welcome Deal
                    </span>
...
watch(() => isSelected.value, (val) => {
    emit('selectedRadio', {id: product.id.value, val: val})
})
